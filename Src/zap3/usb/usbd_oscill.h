...
/** @defgroup usbd_oscill_Exported_Defines
  * @{
  */ 
#define OSCILL_IN_EP                       0x81  /* EP1 for data IN */
#define OSCILL_OUT_EP                      0x01  /* EP1 for data OUT */
#define OSCILL_CMD_EP                      0x82  /* EP2 for OSCILL commands */


# define USB_OSCILL_CONFIG_DESC_SIZ                67
